...
<head>
   ...
   <title>Verificação do Estoque</title>
</head>
<body>
...
include("conexao.php");
include("http://172.16.3.38/Sistemas-Integrados/conexaoIntranetAntiga.php");
...
<div class="container">
    <div class="header">
        ...
        <div class="for">
            <h1>Central de alterações do Estoque</h1> 
            <p>
...
if($parametro){
    $sql = "SELECT * from logs where usuario like '%$parametro%' or visita like '%$parametro%' or item like '%$parametro%' order by ID desc";
    ...
    echo "</tr>";
        ...
        $todos2 = mysqli_query($conn2, "$sql");
        $totalregistros = mysqli_num_rows($todos2);

        $resultado = mysqli_query($conn2, "$sql LIMIT $inicio,$total_registros") or die ("Erro ao tentar cadastrar registro");
